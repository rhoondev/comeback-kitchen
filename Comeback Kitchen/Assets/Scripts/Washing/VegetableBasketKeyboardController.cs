...
//         {
//             GameObject tomato = vegetableBasket.GrabVegetable(vegetableBasket.tomatoSpawner);
//             StartCoroutine(PickUpObjectRoutine(tomato.transform));
//         }
//         else if (Keyboard.current.pKey.wasPressedThisFrame)
//         {
//             GameObject bellPepper = vegetableBasket.GrabVegetable(vegetableBasket.bellPepperSpawner);
//             StartCoroutine(PickUpObjectRoutine(bellPepper.transform));
//         }
//         else if (Keyboard.current.oKey.wasPressedThisFrame)
//         {
//             GameObject onion = vegetableBasket.GrabVegetable(vegetableBasket.onionSpawner);
